...
namespace jx\adminh\models;

use Exception;
use jx\adminh\components\Configs;
use jx\adminh\components\Helper;
use jx\adminh\components\RouteRule;
use Yii;
 ...
 * @since 1.0
 */
class Route extends \jx\adminh\BaseObject
{
    const CACHE_TAG = 'jx.adminh.route';
