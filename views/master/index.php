...
$_columns = [
	...
	[
		...
		'template' => Helper::filterActionColumn('{view} {change-password} {delete} {activate}'),
		'buttons' => [
...
?>
<?php if (Helper::checkRoute('signup')): ?>
	<div class="well well-sm clearfix">
		<div class="pull-left">
			<?= Html::a('<i class="fa fa-plus"></i> ' . Yii::t('rbac-admin', 'Create'), ['signup'], ['class' => 'btn btn-sm btn-info']) ?>
		</div>
