...
namespace jx\adminh\components;
 ...
 *
 * ```
 * Yii::$container->set('jx\adminh\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends \jx\adminh\BaseObject
{
    const CACHE_TAG = 'jx.adminh';
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'jx.adminh.configs', []);
